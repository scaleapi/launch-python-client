...
class LoaderSingleBatchableService(LoaderInferenceServiceImpl[I, O, np.ndarray]):
    def __init__(
        self, Processor: LoaderSpec[ProcessorSingle[I, O]], model: LoaderSpec[ModelSingle]
    ) -> None:
