...
from launch.api_client.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_async_inference_task_v1_async_tasks_post  # this is an instance of the class Endpoint
        api_instance.create_async_inference_task_v1_async_tasks_post()  # this invokes api_instance.create_async_inference_task_v1_async_tasks_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_async_inference_task_v1_async_tasks_post.callable or self.callable in this class
