...
# body param
SchemaForRequestBodyMultipartFormData = BodyUploadFileV1FilesPost


request_body_body = api_client.RequestBody(
    content={
        "multipart/form-data": api_client.MediaType(schema=SchemaForRequestBodyMultipartFormData),
    },
)
_auth = [
    "HTTPBasic",
]
SchemaFor200ResponseBodyApplicationJson = UploadFileResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_file_v1_files_post_oapg(
        self,
...
class UploadFileV1FilesPost(BaseApi):
    ...
    def upload_file_v1_files_post(
        ...
        return self._upload_file_v1_files_post_oapg(
            body=body,
