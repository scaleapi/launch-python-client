...
# body param
SchemaForRequestBodyApplicationJson = CompletionV2Request


request_body_completion_v2_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _completion_v2_completions_post_oapg(
        self,
    ...
    def _completion_v2_completions_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_completion_v2_request.serialize(body, content_type)
...
class CompletionV2CompletionsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def completion_v2_completions_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def completion_v2_completions_post(
        ...
        return self._completion_v2_completions_post_oapg(
            body=body,
