...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_async_inference_task_v1_async_tasks_task_id_get_oapg(
        self,
...
class GetAsyncInferenceTaskV1AsyncTasksTaskIdGet(BaseApi):
    ...
    def get_async_inference_task_v1_async_tasks_task_id_get(
        ...
        return self._get_async_inference_task_v1_async_tasks_task_id_get_oapg(
