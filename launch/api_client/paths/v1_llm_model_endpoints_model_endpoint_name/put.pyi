...
from launch_client.model.update_llm_model_endpoint_v1_request import (
    UpdateLLMModelEndpointV1Request,
)
from launch_client.model.update_llm_model_endpoint_v1_response import (
...
# body param
SchemaForRequestBodyApplicationJson = UpdateLLMModelEndpointV1Request

request_body_update_llm_model_endpoint_v1_request = api_client.RequestBody(
    content={
        "application/json": api_client.MediaType(schema=SchemaForRequestBodyApplicationJson),
    },
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = UpdateLLMModelEndpointV1Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_model_endpoint_v1_llm_model_endpoints_model_endpoint_name_put_oapg(
        self,
    ...
    def _update_model_endpoint_v1_llm_model_endpoints_model_endpoint_name_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_llm_model_endpoint_v1_request.serialize(body, content_type)
...
class UpdateModelEndpointV1LlmModelEndpointsModelEndpointNamePut(BaseApi):
    ...
    def update_model_endpoint_v1_llm_model_endpoints_model_endpoint_name_put(
        ...
        return self._update_model_endpoint_v1_llm_model_endpoints_model_endpoint_name_put_oapg(
            body=body,
