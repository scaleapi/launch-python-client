...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_fine_tune_events_v1_llm_fine_tunes_model_endpoint_name_events_get_oapg(
        self,
...
class GetFineTuneEventsV1LlmFineTunesModelEndpointNameEventsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_fine_tune_events_v1_llm_fine_tunes_model_endpoint_name_events_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_fine_tune_events_v1_llm_fine_tunes_model_endpoint_name_events_get(
        ...
        return self._get_fine_tune_events_v1_llm_fine_tunes_model_endpoint_name_events_get_oapg(
