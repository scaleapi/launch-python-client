...
class PathValues(str, enum.Enum):
    ...
    V1_MODELENDPOINTS_MODEL_ENDPOINT_ID_RESTART = "/v1/model-endpoints/{model_endpoint_id}/restart"
    ...
    V2_BATCHCOMPLETIONS = "/v2/batch-completions"
    V2_BATCHCOMPLETIONS_BATCH_COMPLETION_ID = "/v2/batch-completions/{batch_completion_id}"
    V2_BATCHCOMPLETIONS_BATCH_COMPLETION_ID_ACTIONS_CANCEL = "/v2/batch-completions/{batch_completion_id}/actions/cancel"
    V2_CHAT_COMPLETIONS = "/v2/chat/completions"
    V2_COMPLETIONS = "/v2/completions"
