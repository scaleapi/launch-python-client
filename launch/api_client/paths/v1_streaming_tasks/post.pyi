...
from launch_client.model.sync_endpoint_predict_v1_request import SyncEndpointPredictV1Request
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_streaming_inference_task_v1_streaming_tasks_post_oapg(
        self,
        body: typing.Union[
    ...
    def _create_streaming_inference_task_v1_streaming_tasks_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sync_endpoint_predict_v1_request.serialize(
            body, content_type
        )
...
class CreateStreamingInferenceTaskV1StreamingTasksPost(BaseApi):
    ...
    def create_streaming_inference_task_v1_streaming_tasks_post(
        ...
        return self._create_streaming_inference_task_v1_streaming_tasks_post_oapg(
            body=body,
