...
from launch_client.model.update_trigger_v1_response import UpdateTriggerV1Response
from launch_client.model.update_trigger_v1_request import UpdateTriggerV1Request
...
request_path_trigger_id = api_client.PathParameter(
    name="trigger_id",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateTriggerV1Request
...
class UpdateTriggerV1TriggersTriggerIdPut(BaseApi):
    ...
    def update_trigger_v1_triggers_trigger_id_put(
        ...
        return self._update_trigger_v1_triggers_trigger_id_put_oapg(
            body=body,
