...
# body param
SchemaForRequestBodyApplicationJson = ChatCompletionV2Request


request_body_chat_completion_v2_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _chat_completion_v2_chat_completions_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_chat_completion_v2_request.serialize(body, content_type)
...
class ChatCompletionV2ChatCompletionsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def chat_completion_v2_chat_completions_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def chat_completion_v2_chat_completions_post(
        ...
        return self._chat_completion_v2_chat_completions_post_oapg(
            body=body,
