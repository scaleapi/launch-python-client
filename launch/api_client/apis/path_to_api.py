...
from launch.api_client.apis.paths.v1_model_endpoints_model_endpoint_id_restart import (
    V1ModelEndpointsModelEndpointIdRestart,
)
...
from launch.api_client.apis.paths.v2_batch_completions import (
    V2BatchCompletions,
)
from launch.api_client.apis.paths.v2_batch_completions_batch_completion_id import (
    V2BatchCompletionsBatchCompletionId,
)
from launch.api_client.apis.paths.v2_batch_completions_batch_completion_id_actions_cancel import (
