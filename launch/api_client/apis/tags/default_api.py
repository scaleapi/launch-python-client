...
from launch.api_client.paths.v1_triggers.post import (
    CreateTriggerV1TriggersPost,
)
from launch.api_client.paths.v1_triggers_trigger_id.delete import (
    DeleteTriggerV1TriggersTriggerIdDelete,
)
from launch.api_client.paths.v1_triggers_trigger_id.get import (
