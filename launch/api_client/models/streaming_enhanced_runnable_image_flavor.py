...
class StreamingEnhancedRunnableImageFlavor(BaseModel):
    """
    ...
    streaming_command: List[StrictStr]
    streaming_predict_route: Optional[StrictStr] = "/stream"
    tag: StrictStr
    ...
    def flavor_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["streaming_enhanced_runnable_image"]):
            raise ValueError("must be one of enum values ('streaming_enhanced_runnable_image')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StreamingEnhancedRunnableImageFlavor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StreamingEnhancedRunnableImageFlavor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "streaming_command": obj.get("streaming_command"),
                "streaming_predict_route": obj.get("streaming_predict_route")
                if obj.get("streaming_predict_route") is not None
                else "/stream",
                "tag": obj.get("tag"),
            }
        )
