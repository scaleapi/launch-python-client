...
class ListLLMModelEndpointsV1Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListLLMModelEndpointsV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListLLMModelEndpointsV1Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "model_endpoints": [GetLLMModelEndpointV1Response.from_dict(_item) for _item in obj["model_endpoints"]]
