...
class CustomFramework(BaseModel):
    ...
    image_tag: StrictStr
    __properties: ClassVar[List[str]] = ["framework_type", "image_repository", "image_tag"]

    @field_validator("framework_type")
    def framework_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["custom_base_image"]):
            raise ValueError("must be one of enum values ('custom_base_image')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomFramework from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomFramework from a dict"""
        if obj is None:
            return None
