...
class CreateDockerImageBatchJobResourceRequests(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cpus", "gpu_type", "gpus", "memory", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDockerImageBatchJobResourceRequests from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDockerImageBatchJobResourceRequests from a dict"""
        if obj is None:
            return None
