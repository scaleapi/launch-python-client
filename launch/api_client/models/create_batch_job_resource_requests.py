...
class CreateBatchJobResourceRequests(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cpus", "gpu_type", "gpus", "max_workers", "memory", "per_worker", "storage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBatchJobResourceRequests from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBatchJobResourceRequests from a dict"""
        if obj is None:
            return None
