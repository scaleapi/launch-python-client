...
from launch.api_client.models.flavor import Flavor
...
class CreateModelBundleV2Request(BaseModel):
    ...
    name: StrictStr
    schema_location: StrictStr
    __properties: ClassVar[List[str]] = ["flavor", "metadata", "name", "schema_location"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateModelBundleV2Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateModelBundleV2Request from a dict"""
        if obj is None:
            return None
