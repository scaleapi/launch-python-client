...
class CreateBatchCompletionsModelConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["checkpoint_path", "labels", "model", "num_shards", "quantize", "seed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBatchCompletionsModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBatchCompletionsModelConfig from a dict"""
        if obj is None:
            return None
