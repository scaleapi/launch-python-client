...
class TensorflowFramework(BaseModel):
    ...
    tensorflow_version: StrictStr
    __properties: ClassVar[List[str]] = ["framework_type", "tensorflow_version"]

    @field_validator("framework_type")
    def framework_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["tensorflow"]):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"framework_type": obj.get("framework_type"), "tensorflow_version": obj.get("tensorflow_version")}
        )
        return _obj
