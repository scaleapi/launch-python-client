...
class PytorchFramework(BaseModel):
    ...
    pytorch_image_tag: StrictStr
    __properties: ClassVar[List[str]] = ["framework_type", "pytorch_image_tag"]

    @field_validator("framework_type")
    def framework_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["pytorch"]):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"framework_type": obj.get("framework_type"), "pytorch_image_tag": obj.get("pytorch_image_tag")}
        )
        return _obj
