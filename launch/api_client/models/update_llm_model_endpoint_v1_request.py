...
class UpdateLLMModelEndpointV1Request(BaseModel):
    ...
    min_workers: Optional[StrictInt] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLLMModelEndpointV1Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLLMModelEndpointV1Request from a dict"""
        if obj is None:
            return None
