...
class ListTriggersV1Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTriggersV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTriggersV1Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "triggers": [GetTriggerV1Response.from_dict(_item) for _item in obj["triggers"]]
