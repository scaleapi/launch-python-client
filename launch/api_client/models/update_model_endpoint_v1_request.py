...
class UpdateModelEndpointV1Request(BaseModel):
    ...
    gpus: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    high_priority: Optional[StrictBool] = None
    labels: Optional[Dict[str, StrictStr]] = None
    max_workers: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    memory: Optional[Memory] = None
    metadata: Optional[Dict[str, Any]] = None
    min_workers: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    model_bundle_id: Optional[StrictStr] = None
    optimize_costs: Optional[StrictBool] = None
    per_worker: Optional[StrictInt] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateModelEndpointV1Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateModelEndpointV1Request from a dict"""
        if obj is None:
            return None
