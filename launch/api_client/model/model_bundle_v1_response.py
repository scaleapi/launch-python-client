...
class ModelBundleV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "location", "requirements", "env_params", "packaging_type", "metadata", "created_at", "model_artifact_ids", "app_config", "schema_location", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "location", "requirements", "env_params", "packaging_type", "metadata", "created_at", "model_artifact_ids", "app_config", "schema_location", ], str]):
        return super().get_item_oapg(name)
