...
class EndpointPredictV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["args", "callback_auth", "callback_url", "cloudpickle", "return_pickled", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["args", "callback_auth", "callback_url", "cloudpickle", "return_pickled", "url", ], str]):
