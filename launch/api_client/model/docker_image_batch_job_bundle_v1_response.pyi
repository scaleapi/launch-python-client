...
class DockerImageBatchJobBundleV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["command", "created_at", "env", "id", "image_repository", "image_tag", "name", "cpus", "gpu_type", "gpus", "memory", "mount_location", "public", "storage", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["command", "created_at", "env", "id", "image_repository", "image_tag", "name", "cpus", "gpu_type", "gpus", "memory", "mount_location", "public", "storage", ], str]):
        return super().get_item_oapg(name)
