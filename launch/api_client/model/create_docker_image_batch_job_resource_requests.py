...
class CreateDockerImageBatchJobResourceRequests(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cpus", "memory", "gpus", "gpu_type", "storage", "nodes_per_worker", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cpus", "memory", "gpus", "gpu_type", "storage", "nodes_per_worker", ], str]):
