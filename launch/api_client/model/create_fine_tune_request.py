...
class CreateFineTuneRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model", "training_file", "hyperparameters", "validation_file", "suffix", "wandb_config", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["validation_file"]) -> typing.Union[MetaOapg.properties.validation_file, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union[MetaOapg.properties.suffix, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wandb_config"]) -> typing.Union[MetaOapg.properties.wandb_config, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model", "training_file", "hyperparameters", "validation_file", "suffix", "wandb_config", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        training_file: typing.Union[MetaOapg.properties.training_file, str, ],
        hyperparameters: typing.Union[MetaOapg.properties.hyperparameters, dict, frozendict.frozendict, ],
        model: typing.Union[MetaOapg.properties.model, str, ],
        validation_file: typing.Union[MetaOapg.properties.validation_file, None, str, schemas.Unset] = schemas.unset,
        suffix: typing.Union[MetaOapg.properties.suffix, None, str, schemas.Unset] = schemas.unset,
        wandb_config: typing.Union[MetaOapg.properties.wandb_config, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
