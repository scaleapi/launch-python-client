...
class CreateFineTuneRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hyperparameters", "model", "training_file", "suffix", "validation_file", "wandb_config", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hyperparameters", "model", "training_file", "suffix", "validation_file", "wandb_config", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        wandb_config: typing.Union[MetaOapg.properties.wandb_config, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
