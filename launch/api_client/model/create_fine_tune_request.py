...
class CreateFineTuneRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hyperparameters", "model", "training_file", "suffix", "validation_file", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hyperparameters", "model", "training_file", "suffix", "validation_file", ], str]):
        return super().get_item_oapg(name)
