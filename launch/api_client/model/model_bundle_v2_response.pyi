...
class ModelBundleV2Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "flavor", "id", "metadata", "model_artifact_ids", "name", "schema_location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "flavor", "id", "metadata", "model_artifact_ids", "name", "schema_location", ], str]):
