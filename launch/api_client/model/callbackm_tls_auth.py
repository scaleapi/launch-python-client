...
class CallbackmTLSAuth(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cert", "key", "kind", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cert", "key", "kind", ], str]):
