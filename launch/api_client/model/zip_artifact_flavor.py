...
class ZipArtifactFlavor(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["load_predict_fn_module_path"]) -> MetaOapg.properties.load_predict_fn_module_path: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["load_model_fn_module_path"]) -> MetaOapg.properties.load_model_fn_module_path: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["requirements", "framework", "location", "flavor", "load_predict_fn_module_path", "load_model_fn_module_path", "app_config", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["load_predict_fn_module_path"]) -> MetaOapg.properties.load_predict_fn_module_path: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["load_model_fn_module_path"]) -> MetaOapg.properties.load_model_fn_module_path: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["requirements", "framework", "location", "flavor", "load_predict_fn_module_path", "load_model_fn_module_path", "app_config", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        load_model_fn_module_path: typing.Union[MetaOapg.properties.load_model_fn_module_path, str, ],
        location: typing.Union[MetaOapg.properties.location, str, ],
        load_predict_fn_module_path: typing.Union[MetaOapg.properties.load_predict_fn_module_path, str, ],
        app_config: typing.Union[MetaOapg.properties.app_config, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ZipArtifactFlavor':
        return super().__new__(
