...
class ZipArtifactFlavor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["flavor", "framework", "load_model_fn_module_path", "load_predict_fn_module_path", "location", "requirements", "app_config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["flavor", "framework", "load_model_fn_module_path", "load_predict_fn_module_path", "location", "requirements", "app_config", ], str]):
