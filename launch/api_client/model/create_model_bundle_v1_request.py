...
class CreateModelBundleV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["env_params", "location", "name", "packaging_type", "requirements", "app_config", "metadata", "schema_location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["env_params", "location", "name", "packaging_type", "requirements", "app_config", "metadata", "schema_location", ], str]):
