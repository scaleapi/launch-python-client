...
class CreateModelBundleV1Request(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "location", "requirements", "env_params", "packaging_type", "metadata", "app_config", "schema_location", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "location", "requirements", "env_params", "packaging_type", "metadata", "app_config", "schema_location", ], str]):
        return super().get_item_oapg(name)
