...
class CreateBatchJobV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["input_path", "labels", "model_bundle_id", "resource_requests", "serialization_format", "timeout_seconds", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["input_path", "labels", "model_bundle_id", "resource_requests", "serialization_format", "timeout_seconds", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        resource_requests: 'CreateBatchJobResourceRequests',
        serialization_format: 'BatchJobSerializationFormat',
        input_path: typing.Union[MetaOapg.properties.input_path, str, ],
