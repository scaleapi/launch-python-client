...
entity-layer class, it should be a plain data object.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["framework_type", "ecr_repo", "image_tag", "pytorch_image_tag", "tensorflow_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["framework_type", "ecr_repo", "image_tag", "pytorch_image_tag", "tensorflow_version", ], str]):
