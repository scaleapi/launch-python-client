...
class CreateBatchCompletionsRequest(schemas.DictSchema):
    ...
    ) -> MetaOapg.properties.data_parallelism: ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["input_data_path"]
    ) -> MetaOapg.properties.input_data_path: ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["max_runtime_sec"]
    ) -> MetaOapg.properties.max_runtime_sec: ...
    @typing.overload
...
from launch_client.model.create_batch_completions_model_config import (
    CreateBatchCompletionsModelConfig,
)
from launch_client.model.create_batch_completions_request_content import (
    CreateBatchCompletionsRequestContent,
)
from launch_client.model.tool_config import ToolConfig
