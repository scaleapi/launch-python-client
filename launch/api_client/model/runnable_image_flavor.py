...
class RunnableImageFlavor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["command", "flavor", "protocol", "repository", "tag", "env", "readiness_initial_delay_seconds", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["command", "flavor", "protocol", "repository", "tag", "env", "readiness_initial_delay_seconds", ], str]):
        return super().get_item_oapg(name)
