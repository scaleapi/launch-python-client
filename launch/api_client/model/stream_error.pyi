...
class StreamError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status_code", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status_code", "content", ], str]):
