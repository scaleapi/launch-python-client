...
class CustomFramework(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["framework_type", "image_repository", "image_tag", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["framework_type", "image_repository", "image_tag", ], str]):
