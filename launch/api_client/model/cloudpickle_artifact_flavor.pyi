...
class CloudpickleArtifactFlavor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["flavor", "framework", "load_model_fn", "load_predict_fn", "location", "requirements", "app_config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["flavor", "framework", "load_model_fn", "load_predict_fn", "location", "requirements", "app_config", ], str]):
