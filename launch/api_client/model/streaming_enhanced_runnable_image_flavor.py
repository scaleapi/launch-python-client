...
class StreamingEnhancedRunnableImageFlavor(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["flavor", "protocol", "repository", "streaming_command", "tag", "command", "env", "healthcheck_route", "predict_route", "readiness_initial_delay_seconds", "streaming_predict_route", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["flavor", "protocol", "repository", "streaming_command", "tag", "command", "env", "healthcheck_route", "predict_route", "readiness_initial_delay_seconds", "streaming_predict_route", ], str]):
        return super().get_item_oapg(name)
