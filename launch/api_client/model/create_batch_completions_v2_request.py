...
class CreateBatchCompletionsV2Request(
    schemas.DictSchema
):
                ...
                class MetaOapg:
                    ...
                    class any_of_1(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['FilteredCompletionV2Request']:
                                return FilteredCompletionV2Request
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['FilteredCompletionV2Request'], typing.List['FilteredCompletionV2Request']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'any_of_1':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'FilteredCompletionV2Request':
                    ...
                    class any_of_2(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['FilteredChatCompletionV2Request']:
                                return FilteredChatCompletionV2Request
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['FilteredChatCompletionV2Request'], typing.List['FilteredChatCompletionV2Request']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'any_of_2':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'FilteredChatCompletionV2Request':
                            return super().__getitem__(i)
