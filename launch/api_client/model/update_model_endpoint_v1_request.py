...
class UpdateModelEndpointV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["aws_role", "billing_tags", "cpus", "default_callback_auth", "default_callback_url", "gpu_type", "gpus", "high_priority", "labels", "max_workers", "memory", "metadata", "min_workers", "model_bundle_id", "optimize_costs", "per_worker", "post_inference_hooks", "prewarm", "results_s3_bucket", "storage", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
