...
created via the "supply a docker image for a k8s job" API.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "created_by", "id", "owner", "status", "annotations", "completed_at", "override_job_max_runtime_s", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "created_by", "id", "owner", "status", "annotations", "completed_at", "override_job_max_runtime_s", ], str]):
        return super().get_item_oapg(name)
