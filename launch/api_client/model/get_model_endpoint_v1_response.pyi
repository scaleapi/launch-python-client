...
class GetModelEndpointV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bundle_name", "created_at", "created_by", "destination", "endpoint_type", "id", "last_updated_at", "name", "status", "aws_role", "default_callback_auth", "default_callback_url", "deployment_name", "deployment_state", "labels", "metadata", "num_queued_items", "post_inference_hooks", "public_inference", "resource_state", "results_s3_bucket", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        num_queued_items: typing.Union[MetaOapg.properties.num_queued_items, decimal.Decimal, int, schemas.Unset] = schemas.unset,
