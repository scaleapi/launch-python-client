...
class CreateLLMModelEndpointV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cpus", "gpu_type", "gpus", "inference_framework_image_tag", "labels", "max_workers", "memory", "metadata", "min_workers", "model_name", "name", "per_worker", "billing_tags", "checkpoint_path", "default_callback_auth", "default_callback_url", "endpoint_type", "high_priority", "inference_framework", "num_shards", "optimize_costs", "post_inference_hooks", "prewarm", "public_inference", "quantize", "source", "storage", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["inference_framework_image_tag"]) -> MetaOapg.properties.inference_framework_image_tag: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        inference_framework_image_tag: typing.Union[MetaOapg.properties.inference_framework_image_tag, str, ],
        ...
        endpoint_type: typing.Union[MetaOapg.properties.endpoint_type, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        high_priority: typing.Union[MetaOapg.properties.high_priority, bool, schemas.Unset] = schemas.unset,
        inference_framework: typing.Union[MetaOapg.properties.inference_framework, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
