...
class CreateBatchJobResourceRequests(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cpus", "gpu_type", "gpus", "max_workers", "memory", "per_worker", "storage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cpus", "gpu_type", "gpus", "max_workers", "memory", "per_worker", "storage", ], str]):
