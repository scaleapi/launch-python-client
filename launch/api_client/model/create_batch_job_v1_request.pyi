...
class CreateBatchJobV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model_bundle_id", "input_path", "serialization_format", "labels", "resource_requests", "timeout_seconds", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model_bundle_id", "input_path", "serialization_format", "labels", "resource_requests", "timeout_seconds", ], str]):
        return super().get_item_oapg(name)
