...
class ListFineTuneJobResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class jobs(schemas.ListSchema):
                class MetaOapg:
                    @staticmethod
                    def items() -> typing.Type["GetFineTuneJobResponse"]:
                        return GetFineTuneJobResponse

                def __new__(
                    cls,
                    _arg: typing.Union[
                        typing.Tuple["GetFineTuneJobResponse"],
                        typing.List["GetFineTuneJobResponse"],
                    ],
                ...
                def __getitem__(self, i: int) -> "GetFineTuneJobResponse":
