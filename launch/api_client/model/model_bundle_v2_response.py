...
class ModelBundleV2Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "metadata", "created_at", "model_artifact_ids", "flavor", "schema_location", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "metadata", "created_at", "model_artifact_ids", "flavor", "schema_location", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        schema_location: typing.Union[MetaOapg.properties.schema_location, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
