...
created via the "supply a docker image for a k8s job" API.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "created_by", "owner", "created_at", "status", "completed_at", "annotations", "override_job_max_runtime_s", "num_workers", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["num_workers"]) -> typing.Union[MetaOapg.properties.num_workers, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "created_by", "owner", "created_at", "status", "completed_at", "annotations", "override_job_max_runtime_s", "num_workers", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        annotations: typing.Union[MetaOapg.properties.annotations, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        ...
        num_workers: typing.Union[MetaOapg.properties.num_workers, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
