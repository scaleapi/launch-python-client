...
class ModelEndpointDeploymentState(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["unavailable_workers"]) -> MetaOapg.properties.unavailable_workers: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["max_workers", "min_workers", "per_worker", "available_workers", "unavailable_workers", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["unavailable_workers"]) -> typing.Union[MetaOapg.properties.unavailable_workers, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["max_workers", "min_workers", "per_worker", "available_workers", "unavailable_workers", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        available_workers: typing.Union[MetaOapg.properties.available_workers, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        unavailable_workers: typing.Union[MetaOapg.properties.unavailable_workers, decimal.Decimal, int, schemas.Unset] = schemas.unset,
