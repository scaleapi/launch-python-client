...
class GetLLMModelEndpointV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "inference_framework", "name", "source", "status", "inference_framework_image_tag", "model_name", "num_shards", "quantize", "spec", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "inference_framework", "name", "source", "status", "inference_framework_image_tag", "model_name", "num_shards", "quantize", "spec", ], str]):
