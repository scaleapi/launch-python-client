...
class SyncEndpointPredictV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "result", "traceback", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "result", "traceback", ], str]):
