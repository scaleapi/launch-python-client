...
class SyncEndpointPredictV1Response(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "result", "traceback", "status_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "result", "traceback", "status_code", ], str]):
