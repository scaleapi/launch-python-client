...
class GetFileResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "id", "size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "id", "size", ], str]):
