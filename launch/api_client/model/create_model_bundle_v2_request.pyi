...
class CreateModelBundleV2Request(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["flavor", "name", "schema_location", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["flavor", "name", "schema_location", "metadata", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        flavor: typing.Union[MetaOapg.properties.flavor, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        name: typing.Union[MetaOapg.properties.name, str, ],
        schema_location: typing.Union[MetaOapg.properties.schema_location, str, ],
...
from launch_client.model.streaming_enhanced_runnable_image_flavor import StreamingEnhancedRunnableImageFlavor
