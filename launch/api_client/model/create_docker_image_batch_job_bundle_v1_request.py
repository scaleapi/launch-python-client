...
class CreateDockerImageBatchJobBundleV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["command", "image_repository", "image_tag", "name", "env", "mount_location", "public", "resource_requests", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["command", "image_repository", "image_tag", "name", "env", "mount_location", "public", "resource_requests", ], str]):
        return super().get_item_oapg(name)
