...
class UpdateBatchCompletionsV2Request(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["job_id", "priority", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["job_id", "priority", ], str]):
