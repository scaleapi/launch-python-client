...
class GetAsyncTaskV1Response(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "result", "traceback", "status_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["task_id", "status", "result", "traceback", "status_code", ], str]):
