...
class CompletionStreamOutput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["finished", "text", "num_completion_tokens", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["finished", "text", "num_completion_tokens", "token", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        num_completion_tokens: typing.Union[MetaOapg.properties.num_completion_tokens, decimal.Decimal, int, schemas.Unset] = schemas.unset,
