...
class ListDockerImageBatchJobsV1Response(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class jobs(schemas.ListSchema):
                class MetaOapg:
                    @staticmethod
                    def items() -> typing.Type["DockerImageBatchJob"]:
                ...
                def __getitem__(self, i: int) -> "DockerImageBatchJob":
...
from launch_client.model.docker_image_batch_job import DockerImageBatchJob
