...
class CompletionStreamV1Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["max_new_tokens", "prompt", "temperature", "return_token_log_probs", "stop_sequences", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["max_new_tokens", "prompt", "temperature", "return_token_log_probs", "stop_sequences", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        return_token_log_probs: typing.Union[MetaOapg.properties.return_token_log_probs, bool, schemas.Unset] = schemas.unset,
