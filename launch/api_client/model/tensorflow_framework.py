...
class TensorflowFramework(
    ...
    tensorflow_version: MetaOapg.properties.tensorflow_version
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["framework_type", "tensorflow_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["framework_type", "tensorflow_version", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        tensorflow_version: typing.Union[MetaOapg.properties.tensorflow_version, str, ],
