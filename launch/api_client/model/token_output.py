...
class TokenOutput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "log_prob", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "log_prob", ], str]):
