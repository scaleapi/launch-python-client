...
class TokenOutput(
    ...
    log_prob: MetaOapg.properties.log_prob
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["log_prob", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["log_prob", "token", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        log_prob: typing.Union[MetaOapg.properties.log_prob, decimal.Decimal, int, float, ],
