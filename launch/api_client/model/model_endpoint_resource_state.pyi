...
class ModelEndpointResourceState(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cpus", "gpus", "memory", "gpu_type", "optimize_costs", "storage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cpus", "gpus", "memory", "gpu_type", "optimize_costs", "storage", ], str]):
