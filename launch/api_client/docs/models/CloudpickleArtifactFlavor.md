# launch.api_client.model.cloudpickle_artifact_flavor.CloudpickleArtifactFlavor
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | This is the entity-layer class for the Model Bundle flavor of a cloudpickle artifact. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**flavor** | str,  | str,  |  | must be one of ["cloudpickle_artifact", ] 
...
**load_model_fn** | str,  | str,  |  | 
**location** | str,  | str,  |  | 
**load_predict_fn** | str,  | str,  |  | 
