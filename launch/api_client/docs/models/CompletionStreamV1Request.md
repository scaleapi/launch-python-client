# launch.api_client.model.completion_stream_v1_request.CompletionStreamV1Request
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Request object for a stream prompt completion task. | 
