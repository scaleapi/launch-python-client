# launch.api_client.model.create_deep_speed_model_endpoint_request.CreateDeepSpeedModelEndpointRequest
...
**inference_framework** | str,  | str,  |  | [optional] must be one of ["deepspeed", ] if omitted the server will use the default value of "deepspeed"
