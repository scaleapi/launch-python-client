# launch.api_client.model.triton_enhanced_runnable_image_flavor.TritonEnhancedRunnableImageFlavor
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | For deployments that require tritonserver running in a container. | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**flavor** | str,  | str,  |  | must be one of ["triton_enhanced_runnable_image", ] 
**protocol** | str,  | str,  |  | must be one of ["http", ] 
**tag** | str,  | str,  |  | 
**repository** | str,  | str,  |  | 
**triton_commit_tag** | str,  | str,  |  | 
**triton_model_repository** | str,  | str,  |  | 
**[command](#command)** | list, tuple,  | tuple,  |  | 
**triton_num_cpu** | decimal.Decimal, int, float,  | decimal.Decimal,  |  | 
...
**[triton_model_replicas](#triton_model_replicas)** | dict, frozendict.frozendict, None,  | frozendict.frozendict, NoneClass,  |  | [optional] 
**triton_storage** | None, str,  | NoneClass, str,  |  | [optional] 
**triton_memory** | None, str,  | NoneClass, str,  |  | [optional] 
**triton_readiness_initial_delay_seconds** | decimal.Decimal, int,  | decimal.Decimal,  |  | [optional] if omitted the server will use the default value of 300
