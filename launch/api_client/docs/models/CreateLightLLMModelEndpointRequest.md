# launch.api_client.model.create_light_llm_model_endpoint_request.CreateLightLLMModelEndpointRequest
...
**inference_framework** | str,  | str,  |  | [optional] must be one of ["lightllm", ] if omitted the server will use the default value of "lightllm"
