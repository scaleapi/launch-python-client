...
class LaunchClient:
    ...
    def create_model_bundle_from_dirs(
        ...
        *,
        ...
        """
        self.create_model_bundle_from_dirs_v1(
    ...
    def create_model_bundle(  # pylint: disable=too-many-statements
        ...
        *,
        ...
        self.create_model_bundle(
            model_bundle_name=model_bundle_name,
            env_params=env_params,
            load_predict_fn=load_predict_fn,
            predict_fn_or_cls=predict_fn_or_cls,
    ...
    # V1 functions
    ###
    def create_model_bundle_from_dirs_v1(
        self,
        *,
        model_bundle_name: str,
        base_paths: List[str],
    ...
    def list_model_bundles_v1(self) -> List[Dict[str, Any]]:
        ...
        Returns:
            A list of JSON objects that correspond to the bundles that the user owns.
        """
        with ApiClient(self.configuration) as api_client:
            api_instance = DefaultApi(api_client)
            response = api_instance.list_model_bundles_v1_model_bundles_get(
    ...
    def get_model_bundle_by_id_v1(self, model_bundle_id: str) -> Dict[str, Any]:
        ...
        with ApiClient(self.configuration) as api_client:
            ...
            response = api_instance.get_model_bundle_v1_model_bundles_model_bundle_id_get(  # type: ignore
                path_params=path_params,  # type: ignore
                skip_deserialization=True,
            )
            return json.loads(response.response.data)
    ...
    def get_model_endpoint_by_name_v1(
        ...
        Parameters:
            model_endpoint_name: The name of the endpoint to retrieve.
        """
        with ApiClient(self.configuration) as api_client:
            api_instance = DefaultApi(api_client)
            query_params = frozendict({"name": model_endpoint_name})
            response = api_instance.get_model_endpoints_api_v1_model_endpoints_api_get(  # type: ignore
                query_params=query_params,
                skip_deserialization=True,
            )
