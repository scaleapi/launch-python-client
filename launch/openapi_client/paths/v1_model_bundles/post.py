...
# body param
SchemaForRequestBodyApplicationJson = CreateModelBundleRequest


request_body_create_model_bundle_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_model_bundle_v1_model_bundles_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_model_bundle_request.serialize(body, content_type)
